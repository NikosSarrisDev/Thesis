            ...
            <div style={styles.root}>
                <div style={styles.title}>
                    ...
                    <Typography variant="subtitle1" align="center">
                        ...
                        <h4 style={{color: "grey"}}>Years Of Studies: {user ? user.profile.given_name : "University"}</h4>
                        <h6 style={{color: "grey"}}>Student Id: {user ? user.profile.nickname : "Student Id"}</h6>
                        <h4 style={{color: "grey"}}>Address: {user ? user.profile.middle_name : "Address 01"}</h4>
